...
func TestPostgresAdminInquiryStatusUpdaterIntegration(t *testing.T) {
	...
	// Product table and revision boundary introduced by versions 000004–000005.
...
FROM public.schema_migrations`,
	...
	if migrationCount != 5 || newestMigration != 5 {
		t.Fatalf(
			"migration state: got count=%d newest=%d, want 5/5",
			migrationCount,
			newestMigration,
		)
	}
